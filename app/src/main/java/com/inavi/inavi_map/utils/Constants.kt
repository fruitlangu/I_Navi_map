package com.inavi.inavi_map.utils
...
object Constants {
   ...
   /* val DELIVERY_RANGE_CITIES = listOf("Dobong-gu", "Dongdaemun-gu",
        "Dongjak-gu", "Eunpyeong-gu ", "Eunpyeong-gu", "Gangbuk-gu", "Gangdong-gu", "Gangnam-gu"
    ,"Gangseo-gu","Geumcheon-gu","Guro-gu","Gwanak-gu","Gwangjin-gu","Jongno-gu","Jung-gu","Jungnang-gu","Mapo-gu"
    ,"Nowon-gu","Seocho-gu","Seodaemun-gu","Seongbuk-gu","Seongdong-gu","Songpa-gu","Yangcheon-gu","Yeongdeungpo-gu","Yongsan-gu")*/

    val DELIVERY_RANGE_CITIES = listOf("Seoul")
    //Favorite Direction
