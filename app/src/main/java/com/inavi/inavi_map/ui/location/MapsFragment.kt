...
import com.inavi.inavi_map.databinding.FragmentMapsBinding
import com.inavi.inavi_map.ui.base.BaseFragment
import com.inavi.inavi_map.ui.location.adapter.SuggestionAdapter
...
import com.inavi.inavi_map.utils.Utils.setSafeOnClickListener
...
class MapsFragment : BaseFragment<FragmentMapsBinding>(
    ...
    /**
     * Search the location by using search box
     */
    private fun initSearchView() {
        val bBox = BoundingBox.fromLngLats(126.1086, 33.2533, 129.365,  38.3788)
    ...
    private fun saveAndDismiss(prevDestination: Int?) {
        ...
        if (prevDestination == R.id.locationFragment) {
            navController.safeNavigate(R.id.action_locationFragment_to_mapsFragment)
        } else {
    ...
    /**
     * valid location to check and get the user location
     */
